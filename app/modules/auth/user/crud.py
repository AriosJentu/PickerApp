...
class UserCRUD(BaseCRUD[User]):
    ...
    async def get_by_username_email(self, user: UserCreate | UserUpdateSecure | UserUpdate) -> UserTupleType:
    ...
    async def is_user_exist(self, user: UserCreate | UserUpdateSecure | UserUpdate) -> UserExistType:
        user_by_username, user_by_email = await self.get_users_by_username_email(user)
